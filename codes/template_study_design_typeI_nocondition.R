    ...
    message_logistic = tryCatch(error = function(e)e, warning = function(w) w,
                                {
                                  ...
                                  model = glm(y~arm, family=quasibinomial, data=data.model)
    ...
    message_poisson = tryCatch(error = function(e)e, warning = function(w) w, 
                               {
                                 ...
                                 model = glm(y~arm, family = quasipoisson, data=data.model)  
...
# under null hypothesis, should pick every arm (actually return 0 in my code)
...
save.image(paste0(filepath, 'GLM_sandwich_extreme_2_arm_typeI_nocondition.RData'))
